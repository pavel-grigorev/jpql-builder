...
import org.thepavel.jpqlbuilder.query.Query;
import org.thepavel.jpqlbuilder.querystring.JpqlStringBuilder;

import java.util.Map;

public class WhereChain extends BaseExpressionChain<WhereChain> implements JpqlQuery {
  private final JpqlStringBuilder stringBuilder;
  private final Query query;

  public WhereChain(JpqlStringBuilder stringBuilder, Query query) {
    this.stringBuilder = stringBuilder;
    this.query = query;
  }

  public WhereChain(Operator operator, JpqlStringBuilder stringBuilder, Query query) {
    super(operator);
    this.stringBuilder = stringBuilder;
    this.query = query;
